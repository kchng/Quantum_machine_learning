...
for i in range(len(dtau)):
   os.system("mv N4x4x4_L200_U9_Mu0_T%s.HSF.stream N4x4x4_L200_U9_Mu0_T%.3f.HSF.stream" %(dtau[i],float(dtau[i])))
os.system("ls -l N4x4x4_L200_U9_Mu0_T* | awk '{print $9}' | sed -e s/N4x4x4_L200_U9_Mu0_T//g -e s/.HSF.stream//g > dtau.dat")
...
initialize.randomize_data(memory_size = 'high',shuffle_data=True)
