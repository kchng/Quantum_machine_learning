...
#np.savetxt("20160827-1803_model_U5+U16_CNN0i_test_acc_87.9_W_conv2.dat", output_data)

w = W_fc2.eval()
w_shape = np.array(np.shape(w))
output_data = tf.reshape(w,(w_shape[0],w_shape[-1])).eval()
np.savetxt("20160827-1803_model_U5+U16_CNN0i_test_acc_87.9_W_fc2.dat", output_data)
