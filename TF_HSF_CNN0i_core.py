...
class optimise_hyperparameters :
    ...
    def insert_hyperparameters(self, n_feature_map1, n_feature_map2, n_feature_map3, n_feature_map4, n_fully_connected_neuron, 
        ...
        print "(Conv + ReLu) 1: %d, (Conv + ReLu) 2: %d, (Conv + ReLu) 3: %d, (Conv + ReLu) 4: %d, fc 1: %d" %(n_feature_map1, n_feature_map2, n_feature_map3, n_feature_map4, n_fully_connected_neuron)
        ...
        if name_output_file_by_date_first == False :
            if use_single_U :
                ...
                filename_weight_bias = "./model_U%d_" % U + NNetwork + "_CR1%d_CR2%d_CR3%d_CR4%d_fc%d" % (n_feature_map1, n_feature_map2, n_feature_map3, n_feature_map4, n_fully_connected_neuron) + "_test_acc_%.1f_" + start_date_time + ".ckpt"

                # Output of training measurements filename
                filename_measure     = "./measurements_U%d_" % U + NNetwork + "_CR1%d_CR2%d_CR3%d_CR4%d_fc%d" % (n_feature_map1, n_feature_map2, n_feature_map3, n_feature_map4, n_fully_connected_neuron) + "_test_acc_%.1f_" + start_date_time + ".dat"

                # Output of classification result with labels
                filename_result      = "./result_U%d_" % U + NNetwork + "_CR1%d_CR2%d_CR3%d_CR4%d_fc%d" % (n_feature_map1, n_feature_map2, n_feature_map3, n_feature_map4, n_fully_connected_neuron) + "_test_acc_%.1f_" + start_date_time + ".dat"

            else :
                # Output model filename
                filename_weight_bias = "./model_U%d+U%d_" % (U1,U2) + NNetwork + "_CR1%d_CR2%d_CR3%d_CR4%d_fc%d" % (n_feature_map1, n_feature_map2, n_feature_map3, n_feature_map4, n_fully_connected_neuron) + "_test_acc_%.1f_" + start_date_time + ".ckpt"

                # Output of training measurements filename
                filename_measure     = "./measurements_U%d+U%d_" % (U1,U2) + NNetwork + "_CR1%d_CR2%d_CR3%d_CR4%d_fc%d" % (n_feature_map1, n_feature_map2, n_feature_map3, n_feature_map4, n_fully_connected_neuron) + "_test_acc_%.1f_" + start_date_time + ".dat"

                # Output of classification result with labels
                filename_result      = "./result_U%d+U%d_" % (U1,U2) + NNetwork + "_CR1%d_CR2%d_CR3%d_CR4%d_fc%d" % (n_feature_map1, n_feature_map2, n_feature_map3, n_feature_map4, n_fully_connected_neuron) + "_test_acc_%.1f_" + start_date_time + ".dat"

        else :
            if use_single_U :
                # Output model filename
                filename_weight_bias = "./" + start_date_time + "_model_U%d_" % U + NNetwork + "_CR1%d_CR2%d_CR3%d_CR4%d_fc%d" % (n_feature_map1, n_feature_map2, n_feature_map3, n_feature_map4, n_fully_connected_neuron) + "_test_acc_%.1f.ckpt"

                # Output of training measurements filename
                filename_measure     = "./" + start_date_time + "_measurements_U%d_" % U + NNetwork + "_CR1%d_CR2%d_CR3%d_CR4%d_fc%d" % (n_feature_map1, n_feature_map2, n_feature_map3, n_feature_map4, n_fully_connected_neuron) + "_test_acc_%.1f.dat"
        
                # Output of classification result with labels
                filename_result      = "./" + start_date_time + "_result_U%d_" % U + NNetwork + "_CR1%d_CR2%d_CR3%d_CR4%d_fc%d" % (n_feature_map1, n_feature_map2, n_feature_map3, n_feature_map4, n_fully_connected_neuron) + "_test_acc_%.1f.dat"

            else :
                # Output model filename
                filename_weight_bias = "./" + start_date_time + "_model_U%d+U%d_" % (U1,U2) + NNetwork + "_CR1%d_CR2%d_CR3%d_CR4%d_fc%d" % (n_feature_map1, n_feature_map2, n_feature_map3, n_feature_map4, n_fully_connected_neuron) + "_test_acc_%.1f.ckpt"

                # Output of training measurements filename
                filename_measure     = "./" + start_date_time + "_measurements_U%d+U%d_" % (U1,U2) + NNetwork + "_CR1%d_CR2%d_CR3%d_CR4%d_fc%d" % (n_feature_map1, n_feature_map2, n_feature_map3, n_feature_map4, n_fully_connected_neuron) + "_test_acc_%.1f.dat"

                # Output of classification result with labels
                filename_result      = "./" + start_date_time + "_result_U%d+U%d_" % (U1,U2) + NNetwork + "_CR1%d_CR2%d_CR3%d_CR4%d_fc%d" % (n_feature_map1, n_feature_map2, n_feature_map3, n_feature_map4, n_fully_connected_neuron) + "_test_acc_%.1f.dat"
        ...
        if not(Overtraining) :
          ...
          print '%.2fs, epoch %.2f, training accuracy %g, test accuracy %g, cost %g' % (time.time()-start_time,(n+1)*fractional_epoch, train_accuracy, test_accuracy, Cost)
        elif Overtraining and file_save_counter > 0 :
          os.remove( filename_measure_tmp )
          filename_measure_tmp = (filename_measure%(best_test_accuracy*100))
        ...
        if not(slow_learning) and not(model_saving_criteria_not_met) :
